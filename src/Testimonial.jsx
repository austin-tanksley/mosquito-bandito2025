...
export default function Testimonial({ data = [] }) {
  ...
  return (
    <div className="container py-24 mx-auto max-w-[1024px] px-1 mb-24">
      <h2 className="mx-auto py-4 mb-8 text-center text-bandito-green border-b-bandito-red border-b-4 font-display text-3xl w-fit">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4">
        ...
        <div
          {...swipeHandlers}
          className="flex-1 min-h-[120px] flex justify-center items-center text-center px-4 overflow-hidden"
        >
          <div ref={contentRef}>
